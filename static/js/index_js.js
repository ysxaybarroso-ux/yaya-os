...
var content = [
    {
        ...
        date:"09/07/2077",
        content:'<p class="notecontent">chap 1 david martinez.... symptomes</p>'
    },
    {
        idea:"test reactivitée",
        date:"09/072026",
        content:'<p class="notecontent"> test le contenu reactif ici </p>'
    }
];
...
function AddPlaylistToSlideBar(index){
    ...
    newDiv.addEventListener("click", () => {ShowTrackOfPlaylist(index);});
